...
class Language(models.Model):
    """
    Modelo que representa un idioma (p. ej. español, inglés, francés, etc.).
    """
    name = models.CharField(max_length=200, help_text="Ingrese el idioma del libro (p. ej. español, inglés, francés, etc.")
...
class BookInstance(models.Model):
    ...
    def __str__(self):
        ...
        """
        book_status = f'{self.id} ({self.book.title})'
        return book_status
